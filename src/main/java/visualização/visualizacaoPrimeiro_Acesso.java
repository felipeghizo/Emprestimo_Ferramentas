...
public class visualizacaoPrimeiro_Acesso extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(visualizacaoPrimeiro_Acesso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new visualizacaoPrimeiro_Acesso().setVisible(true);
            }
        });
